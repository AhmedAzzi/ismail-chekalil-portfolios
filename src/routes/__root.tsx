  ...
  head: () => ({
    meta: [
      ...
      { title: "Ismail Chekalil — Mechanical Engineering · Manufacturing & Materials" },
      {
        name: "description",
        content:
          "Portfolio of Ismail Chekalil, PhD — researcher in metal additive manufacturing, friction stir welding and sustainable manufacturing.",
      },
      { property: "og:title", content: "Ismail Chekalil — Engineering Portfolio" },
      {
        property: "og:description",
        content:
          "Mechanical engineering researcher specialized in additive manufacturing, FSW and materials.",
      },
