...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DHDsXB0M.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-BcMEhxjV.js").then((n) => n.r),
...
var ROUTER_BASEPATH = "ismail-chekalil-portfolios";
var SERVER_FN_BASE = "/ismail-chekalil-portfolios/_serverFn/";
